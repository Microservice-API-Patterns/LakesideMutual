...
call npx concurrently ^
  --kill-others ^
  --names "customer-core,customer-self-service-backend,customer-self-service-frontend,customer-management-backend,customer-management-frontend,policy-management-backend,policy-management-frontend,risk-management-server,spring-boot-admin" ^
  --prefix-colors "bgYellow.bold,bgBlue.bold,bgBlue.bold,bgMagenta.bold,bgMagenta.bold,bgGreen.bold,bgGreen.bold,bgWhite.bold,bgRed.bold" ^
