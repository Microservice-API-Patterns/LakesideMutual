 ...
 * TODO: Could try to support JAX-WS and JAX-RS (or Spring REST) in same controller/port class (in port-and-adapter or hexagon style terms, by A. Cockburn). Might want/have to refactor later.
